...
class Config:
    ...
    scale_factors = [[1.0, 1.5], [1.5, 1.0], [1.5, 1.5], [1.5, 2.0], [2.0, 1.5], [2.0, 2.0]]  # list of pairs (vertical, horizontal) for gradual increments in resolution
    ...
    back_projection_iters = [6, 6, 8, 10, 10, 12]  # for each scale num of bp iterations (same length as scale_factors)
    random_crop = True
    crop_size = 128
